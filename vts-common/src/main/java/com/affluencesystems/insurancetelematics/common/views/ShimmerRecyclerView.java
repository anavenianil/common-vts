...
package com.affluencesystems.insurancetelematics.common.views;
...
import com.affluencesystems.insurancetelematics.common.adapters.ShimmerAdapter;
...
public class ShimmerRecyclerView extends RecyclerView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            setGridChildCount(a.getInteger(R.styleable.ShimmerRecyclerView_shimmer_demo_grid_child_count, 1));
    ...
    /**
     * Sets the layout manager for the shimmer vehicleInfoAdapter.
     *
    ...
    /**
     * Sets the number of demo views should be shown in the shimmer vehicleInfoAdapter.
     *
    ...
    /**
     * Sets the shimmer vehicleInfoAdapter and shows the loading screen.
     */
    ...
    /**
     * Hides the shimmer vehicleInfoAdapter
     */
    ...
    /**
     * Retrieves the actual vehicleInfoAdapter that contains the data set or null if no vehicleInfoAdapter is set.
     *
     * @return The actual vehicleInfoAdapter
     */
